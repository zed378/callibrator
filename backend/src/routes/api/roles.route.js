 ...
 * /api/v1/roles/menus:
 *   get:
 *     summary: Fetch all menu groups (paginated, searchable)
 *     tags: [Roles]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/", auth, rbac(["SUPERADMIN"]), validate(rolesValidator.createRoleSchema), rolesController.createRole);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.patch("/:id", validateUuid("id"), auth, rbac(["SUPERADMIN"]), validate(rolesValidator.updateRoleSchema), rolesController.updateRole);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/menus", auth, rbac(["SUPERADMIN"]), validate(rolesValidator.createMenuSchema), rolesController.createMenu);
